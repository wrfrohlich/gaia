...
class Routine:
    def __init__(self):
        self.config = Config(participant="040103")
    ...
    def run_experiment01(self):
        ...
        corr.cross_correlation_exploratory(
            merged_data, criterion=0.5, best=True, print_fig=False
        )
    ...
    def run_experiment04(self):
        ...
        corr.get_higher_corr(merged_data, level=0.5)
        corr_data = corr.analyze_correlation()
        corr.cross_correlation_analysis(
            merged_data, corr_data, print_fig=True, fontsize=20
        )
        corr.cross_correlation_exploratory(
            merged_data, criterion=0.5, best=True, print_fig=True, fontsize=20
        )

        clust = Clustering(name=name)
        clust.analyze_cross_correlation()
        clust.run_clustering_kmeans_grouped(
            merged_data, method="pca_shift", fontsize=20
        )
