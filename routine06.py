...
from gaia.deep_learning import DeepLearning
...
class Routine:
    ...
    def run_experiment01(self):
        ...
        corr.cross_correlation_exploratory(
            merged_data, criterion=0.4, best=True, print_fig=False
        )
        ...
        dl = DeepLearning(name=name)
        sep_data = dl.sep_data()
        dl.run(sep_data, merged_data)
