...
class Config:
    def __init__(self, participant="040102"):
        ...
        self.gait_lab_point_file = path.join(
            self.data_path, f"point_track_{participant}.emt"
        )
        self.gait_lab_force_file = path.join(
            self.data_path, f"force_track_{participant}.emt"
        )
        ...
        self.body_parts = {
            ...
            "additional_points": ["SHO_x", "SHO_y", "SHO_z", "PO_x", "PO_y", "PO_z"],
            "force": [
                "r_force_x",
                "r_force_y",
                "r_force_z",
